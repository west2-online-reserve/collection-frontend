...
<template>
    <div class="main" style="margin-left:120px; margin-top: 50px;">
        ...
        <el-table :data="filterTableData" empty-text="暂无内容">
            <!-- 表头 -->
            <el-table-column type="index" label="序号" width="120px" align-items="center" />
            <el-table-column label="内容" prop="content" width="480px" align-items="center" />
            <el-table-column label="创建时间" prop="start" width="250px" align-items="center" format="YYYY/MM/DD"
                :sort-method="sortMethod" />
            <el-table-column label="完成时间" prop="end" width="250px" align-items="center" />
            <el-table-column label="操作" align-items="center" width="300px">
                <!-- 操作按钮 -->
                <template #default="scope">
                    <el-button size="large" type="primary" @click="handleComplish(scope)" v-if="!scope.row.completed"
                        ...
                        round>完成</el-button>
                    <el-button size="large" type="primary" @click="handleEdit(scope)" v-if="!scope.row.completed"
                        style="font-size: 20px;font-style: normal;font-weight: 700;" round>修改</el-button>
